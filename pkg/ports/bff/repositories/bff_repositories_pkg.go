...
func NewBffRepository[CE, RE, UE contracts.BffEntity](client bffcts.BffClient) contracts.BffRepository[CE, RE, UE] {
...
func NewBffNestedRepository[CE, RE, UE contracts.BffEntity](client bffcts.BffClient, parentResourceName string) contracts.BffNestedRepository[CE, RE, UE] {
