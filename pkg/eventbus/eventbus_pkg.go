...
// convenient imports such as "github.com/brunojet/go-infra-backend/pkg/eventbus".
// Keeping the minimal surface here prevents import cycles while providing a
// stable package entrypoint.

import (
	"github.com/brunojet/go-infra-backend/internal/eventbus"
	"github.com/brunojet/go-infra-backend/pkg/eventbus/contracts"
)
